...
images_root = '/home/white/Downloads/pdf'
...
bounding_style = False #'rectangle'
bound_offset = (5,20)
bound_weight = 5
...
def init_loaders(opt):
    train_dataset = MotifDS(opt.images_root, opt.vm_root, train=True, image_size=opt.image_size,
                            ...
                            bound_offset=opt.bound_offset,bounding_style=opt.bounding_style,bound_weight=opt.bound_weight,broken=opt.broken)
