...
def load_globals(nets_path, globals_dict, override=True):
    save_set = {
                ...
                'scale_vm', 'crop_vm', 'batch_vm', 'font', 'text_border', 'blur','fontsize','resize_size','bounding_style','bound_offset','bound_weight','broken'
                }
    to_save = False
...
def init_loaders(opt, cache_root=''):
    ...
    train_dataset = CacheLoader(cache_root, train=True, patch_size=opt.patch_size,resize_size=opt.resize_size)
